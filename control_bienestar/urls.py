...
urlpatterns = patterns('',
    ...
    url(r'^actividades/editar/(?P<id_actividad>\d+)', 'actividades.views.editar_actividad', name='actividades-editar'),
    url(r'^actividades/eliminar/(?P<id_actividad>\d+)$', 'actividades.views.actividad_eliminar', name='eliminar-actividad'),
